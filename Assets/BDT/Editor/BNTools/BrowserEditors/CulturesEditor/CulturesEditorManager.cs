...
public class CulturesEditorManager : EditorWindow
{
    ...
    private void ModifySelectedAssets()
    {
        ...
        {
            EditorGUILayout.HelpBox("Zero Culture Selected, " + "\n" + "select at least one Culture before edit it.", MessageType.Error);
        ...
        else
        {
            ...
            EditorGUILayout.HelpBox("Modify selected Culture Assets.", MessageType.Info);
            ...
            if (A_index == 2)
            {
                ...
                if (GUILayout.Button("Remove Selected"))
                {
                    ...
                    foreach (var dic in modifyDic)
                    {
                        ...
                        currMod.modFilesData.culturesData.cultures.Remove(dic);
    ...
    private void WindowModeEdit(ModuleReceiver currMod)
    {
        ...
        if (EditorGUI.EndChangeCheck())
        {
            ...
            for (int i2 = 0; i2 < currMod.modFilesData.culturesData.cultures.Count; i2++)
            {
                for (int i3 = 0; i3 < modifyDic.Count; i3++)
                {
                    ...
                    // Debug.Log(assetName);
                    if (currMod.modFilesData.culturesData.cultures[i2].id == assetName)
                    {
                        contains_Bool = true;
                        // break;
    ...
    private void CheckContains(ModuleReceiver currMod)
    {
        ...
        for (int i2 = 0; i2 < currMod.modFilesData.culturesData.cultures.Count; i2++)
        {
            ...
            if (contains_Bool)
            {
                ...
                for (int i3 = 0; i3 < currMod.modFilesData.culturesData.cultures.Count; i3++)
                {
                    var npcCharObj = currMod.modFilesData.culturesData.cultures[i3];
    ...
    void AssetAsCopy(ModuleReceiver currMod, Culture dic, string naming)
    {
        Culture data = Object.Instantiate(dic);
        ...
        if (data.cultureName == "" || data.cultureName == null)
        {
            data.cultureName = naming;
        }
        ...
        currMod.modFilesData.culturesData.cultures.Add(data);
    }

    void OverrideIfExist(ModuleReceiver currMod, Culture dic, string naming)
    {
        Culture data = Object.Instantiate(dic);
    ...
    {
        for (int index2 = 0; index2 < currMod.modFilesData.culturesData.cultures.Count; index2++)
        {
            var npc = currMod.modFilesData.culturesData.cultures;
            if (npc[index2].id == nameID)
            {
                ...
                currMod.modFilesData.culturesData.cultures.Remove(npc[index2]);
    ...
    private void EditCurrentAssets(Culture dic, string naming)
    {
        var asstPath = AssetDatabase.GetAssetPath(dic);
    ...
    private void CreateAsset()
    {
        ...
        this.title = "Create Culture Asset";

        EditorGUILayout.HelpBox("Create Culture Asset for " + "(" + bdt_settings.currentModule + ")" + " module.", MessageType.Info);
        ...
        if (useObjectRef)
        {
            ...
            Culture eqpRef = (Culture)object_reference_A;
            object_reference_A = EditorGUILayout.ObjectField(eqpRef, typeof(Culture), true);
        ...
        Culture refOBJ = (Culture)object_reference_A;
        ...
        assetID_new = EditorGUILayout.TextField("Culture ID:", assetID_new);
        ...
        if (contains_Bool)
        {
            ...
            for (int i3 = 0; i3 < currMod.modFilesData.culturesData.cultures.Count; i3++)
            {
                var facObj = currMod.modFilesData.culturesData.cultures[i3];
        ...
        Culture eqp = (Culture)ScriptableObject.CreateInstance(typeof(Culture));
        ...
        if (isSelectedRef)
        {
            if (GUILayout.Button(createAssetsLabel))
            {
                ...
                for (int i = 0; i < stack_count; i++)
                {
                    ...
                    Culture eqpAsset = ScriptableObject.CreateInstance<Culture>();

                    if (useObjectRef)
                    {
                        if (object_reference_A != null)
                        {
                            Culture npcRef = (Culture)object_reference_A;
                    ...
                    if (eqpAsset.cultureName == "" || eqpAsset.cultureName == null)
                    {
                        eqpAsset.cultureName = assetName;
                    }
                    ...
                    path = dataPath + currMod.id + "/Cultures/" + assetName + ".asset";
                    ...
                    for (int i2 = 0; i2 < currMod.modFilesData.culturesData.cultures.Count; i2++)
                    {
                        if (currMod.modFilesData.culturesData.cultures[i2].id == eqpAsset.id)
                        {
                            var eqpLoad = (Culture)AssetDatabase.LoadAssetAtPath(path, typeof(Culture));

                            currMod.modFilesData.culturesData.cultures[i2] = eqpLoad;
                            contains_Bool = true;
                            break;
                        }
                    }
                    ...
                    if (!contains_Bool)
                    {
                        var itemLoad = (Culture)AssetDatabase.LoadAssetAtPath(path, typeof(Culture));
                        currMod.modFilesData.culturesData.cultures.Add(itemLoad);
                    }
