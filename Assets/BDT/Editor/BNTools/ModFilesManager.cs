...
public class ModFilesManager : Editor
{
    ...
    public string modsSettingsPath = "Assets/BDT/Resources/SubModulesData/";
    public string modsResourcesPath = "Assets/BDT/Resources/Data/";
    public string settingsAsset = "Assets/BDT/Settings/BDT_settings.asset";
    [SerializeField]
    ...
    public void CreateFactionAssets(XmlNode node, ModFiles modFilesAsset, string xmlFile)
    {
        ...
        if (node.Attributes["banner_key"] != null)
        {
            ...
            var BSpath = "Assets/BDT/Settings/BannersEditor/BannerEditor_settings.asset";
