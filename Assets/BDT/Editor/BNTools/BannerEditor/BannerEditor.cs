...
public class BannerEditor : EditorWindow
{
    ...
    string pivotTexture = "Assets/BDT/Settings/BannersEditor/Resources/pivot.tga";
    ...
    private static void DrawWindowRectsBG(Rect wievRect, Color bgCol)
    {
        ...
        // ! DRAW MAKET
        var editorZonePath = "Assets/BDT/Settings/BannersEditor/Resources/editorMaket.png";
