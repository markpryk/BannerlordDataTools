...
public class TranslationEditor : EditorWindow
{
                ...
                if (!isDependency)
                {
                    ...
                    if (defaultData.langImported == false)
                    {
                        if (GUILayout.Button("Import Existing Languages Strings"))
                        {
                            ...
                            string defaultPath = "Assets/BDT/Resources/SubModulesData/" + module + "/Languages";
                            ...
                            foreach (var mod in currentMod.modDependenciesInternal)
                            {
                                ...
                                {
                                    defaultPath = "Assets/BDT/Resources/SubModulesData/" + mod + "/Languages";
                            ...
                            foreach (string mod in mods)
                            {
                                ...
                                foreach (var depend in iSDependencyOfMod.modDependenciesInternal)
                                {
                                    if (depend == module)
                                    {
                                        defaultPath = "Assets/BDT/Resources/SubModulesData/" + iSDependencyOfMod.id + "/Languages";
    ...
    private void TranslationKeyGenerator(ref string stringTS, string modName, string TSfoldeName, bool GenDataBool)
    {
        ...
        if (GUILayout.Button("Generate Translation Key") || GenDataBool == true)
        {
            ...
            string configPath = "Assets/BDT/Resources/SubModulesData/" + modName + "/" + modName + "_Config.asset";
    ...
    public void SearchStrings()
    {
        ...
        string configPath = "Assets/BDT/Resources/SubModulesData/" + module + "/" + module + "_Config.asset";
    ...
    {
        string engPath = "Assets/BDT/Resources/SubModulesData/" + modName + "/Languages";
        string configPath = "Assets/BDT/Resources/SubModulesData/" + module + "/" + module + "_Config.asset";
        ModFiles modFilesAsset = (ModFiles)AssetDatabase.LoadAssetAtPath(configPath, typeof(ModFiles));
        ...
        string[] lenguageDirectories = Directory.GetDirectories("Assets/BDT/Resources/SubModulesData/" + modName + "/Languages");
