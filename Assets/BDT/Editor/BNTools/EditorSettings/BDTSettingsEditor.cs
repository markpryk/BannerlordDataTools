...
public class BDTSettingsEditor : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        if (settingsAsset.load_a)
        {
            ...
            if (settingsAsset.load_b)
            {
                ...
                {
                    EditorUtility.LoadWindowLayout("Assets/BDT/Settings/BDT_UnityLayout.wlt");
                }
            }
    ...
    private void ImportBannerlordNativeDefinitions(bool write_debug_data_log)
    {
       var _defaultRefreshMode = AssetDatabase.ActiveRefreshImportMode;
        ...
        string debug_path = "Assets/BDT/debug_readed_data.txt";
        ...
        var cp_path_temp = "Assets/BDT/Settings/Definitions/.CraftingPieces/";
        var cp_path_final = "Assets/BDT/Settings/Definitions/CraftingPieces/";
    ...
    public void LoadLenguages(string[] native_modules)
    {
        ...
        var lang_path = "Assets/BDT/Settings/Definitions/Languages/";
    ...
    public void CreateInternalItemTypes()
    {
        ...
        var it_path = "Assets/BDT/Settings/Definitions/ItemTypes/";
    ...
    public void CreateSettlementsDefinitions()
    {
        ...
        var complex_path = "Assets/BDT/Settings/Definitions/LocationComplexTemplate/";
