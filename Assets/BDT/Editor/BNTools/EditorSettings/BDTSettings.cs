...
{
    const string BDT_Version = "0.0.62.0b";
    ...
    public void AssignWorldMapProductionIcons()
    {
        ...
        for (int i = 0; i < VillagesTypeDefinitions.Length; i++)
        {
            ...
            Sprite icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/prod_none.png", typeof(Sprite));
            string def = VillagesTypeDefinitions[i];

            if (def == "none")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/prod_none.png", typeof(Sprite));
            else if (def == "silk_plant")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/silk.png", typeof(Sprite));
            else if (def == "cattle_farm")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/cow.png", typeof(Sprite));
            else if (def == "silver_mine")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/silver.png", typeof(Sprite));
            else if (def == "iron_mine")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/iron.png", typeof(Sprite));
            else if (def == "lumberjack")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/wood.png", typeof(Sprite));
            else if (def == "wheat_farm")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/wheat.png", typeof(Sprite));
            else if (def == "fisherman")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/fish.png", typeof(Sprite));
            else if (def == "europe_horse_ranch")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/euro_horse.png", typeof(Sprite));
            else if (def == "sheep_farm")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/sheep.png", typeof(Sprite));
            else if (def == "flax_plant")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/flax.png", typeof(Sprite));
            else if (def == "vineyard")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/vine.png", typeof(Sprite));
            else if (def == "date_farm")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/dates.png", typeof(Sprite));
            else if (def == "olive_trees")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/olives.png", typeof(Sprite));
            else if (def == "swine_farm")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/swine.png", typeof(Sprite));
            else if (def == "salt_mine")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/salt.png", typeof(Sprite));
            else if (def == "clay_mine")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/clay.png", typeof(Sprite));
            else if (def == "sturgian_horse_ranch")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/sturg_horse.png", typeof(Sprite));
            else if (def == "trapper")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/skin.png", typeof(Sprite));
            else if (def == "desert_horse_ranch")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/desert_horse.png", typeof(Sprite));
            else if (def == "vlandian_horse_ranch")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/vland_horse.png", typeof(Sprite));
            else if (def == "battanian_horse_ranch")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/battan_horse.png", typeof(Sprite));
            else if (def == "steppe_horse_ranch")
                icon = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/steppe_horse.png", typeof(Sprite));
        ...
        //{
        //    var path = "Assets/BDT/Settings/EditorResources/VillageTypesSprites/WMP_Editor/camel.png";
    ...
    public void CheckAndRefreshCraftingPieces()
    {
        if (NativePiecesDefinitions == null || NativePiecesDefinitions.Length == 0 || NativePiecesDefinitions[0] == null)
        {
            ...
            var cp_path = "Assets/BDT/Settings/Definitions/CraftingPieces/";
    ...
    public void CheckGUI()
    {
        if (GUI == null)
        {
            var path = "Assets/BDT/Settings/EditorResources/BDT_GUI/BDT_GUI.asset";
