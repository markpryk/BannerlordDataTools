...
public class ModListPopup : EditorWindow
{
    ...
    void ImportData()
    {
        ...
        string headModulePath = "Assets/BDT/Resources/SubModulesData/";
        string headModuleResourcesPath = "Assets/BDT/Resources/Data/";
    ...
    {
        string dataPath = $"Assets/BDT/Resources/Data/{modID}";
        string sub_dataPath = $"Assets/BDT/Resources/SubModulesData/{modID}";
        string sub_dataPathConfigMeta = $"Assets/BDT/Resources/SubModulesData/{modID}.asset.meta";
        string mod_asset = $"Assets/BDT/Resources/SubModulesData/{modID}.asset";
