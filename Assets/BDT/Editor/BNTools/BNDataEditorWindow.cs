...
public class BNDataEditorWindow : EditorWindow
{
    ...
    string path = "Assets/BDT/Modules/";
    string configPath = "Assets/BDT/Settings/BDT_settings.asset";
     string dataResPath = "Assets/BDT/Resources/Data/";
    ...
    private void CheckModData()
    {
        ...
        {
            string path = "Assets/BDT/Resources/SubModulesData/" + currentMod.id + "/" + currentMod.id + "_Config.asset";
            if (File.Exists(path))
            {
    ...
    void OnGUI()
    {
        ...
        if (settingsAsset != null && settingsAsset.load_a && settingsAsset.load_b)
        {
            ...
            else
            {
                ...
                header_texture = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/BDT/Settings/EditorResources/BDT_GUI/Interface/BDT_Header.png", typeof(Texture2D));
            }
    ...
    public void LoadModProjectData(ref ModuleReceiver modToLoad)
    {
        ...
        string path = "Assets/BDT/Resources/SubModulesData/" + modToLoad.id + "/" + modToLoad.id + "_Config.asset";
        if (File.Exists(path))
        {
            ModFiles data = (ModFiles)AssetDatabase.LoadAssetAtPath(path, typeof(ModFiles));
        ...
        {
            // load asset configs
            path = "Assets/BDT/Resources/SubModulesData/" + modToLoad.id + "/ModDataConfigs/" + "kng_" + modToLoad.id + ".asset";
            if (System.IO.File.Exists(path))
            {
                ...
                path = "Assets/BDT/Resources/Data/" + modToLoad.id + "/Kingdoms";
            ...
            path = "Assets/BDT/Resources/SubModulesData/" + modToLoad.id + "/ModDataConfigs/" + "fac_" + modToLoad.id + ".asset";
            if (System.IO.File.Exists(path))
            {
                ...
                path = "Assets/BDT/Resources/Data/" + modToLoad.id + "/Factions";
                if (AssetDatabase.IsValidFolder(path))
                {
            ...
            path = "Assets/BDT/Resources/SubModulesData/" + modToLoad.id + "/ModDataConfigs/" + "sett_" + modToLoad.id + ".asset";
            if (System.IO.File.Exists(path))
            {
                ...
                path = "Assets/BDT/Resources/Data/" + modToLoad.id + "/Settlements";
                if (AssetDatabase.IsValidFolder(path))
                {
            ...
            path = "Assets/BDT/Resources/SubModulesData/" + modToLoad.id + "/ModDataConfigs/" + "npc_" + modToLoad.id + ".asset";
            ...
            if (System.IO.File.Exists(path))
            {
                ...
                path = "Assets/BDT/Resources/Data/" + modToLoad.id + "/NPC";
                if (AssetDatabase.IsValidFolder(path))
                {
                ...
                // Load Templates
                path = "Assets/BDT/Resources/Data/" + modToLoad.id + "/_Templates/NPCtemplates";
                if (AssetDatabase.IsValidFolder(path))
                {
                    //modToLoad.modFilesData.npcChrData.NPCCharacters = new List<NPCCharacter>();
                    string[] npcAssetFiles = Directory.GetFiles(path, "*.asset");
            ...
            path = "Assets/BDT/Resources/SubModulesData/" + modToLoad.id + "/ModDataConfigs/" + "cult_" + modToLoad.id + ".asset";
            if (System.IO.File.Exists(path))
            {
                ...
                path = "Assets/BDT/Resources/Data/" + modToLoad.id + "/Cultures";
                if (AssetDatabase.IsValidFolder(path))
                {
            ...
            path = "Assets/BDT/Resources/SubModulesData/" + modToLoad.id + "/ModDataConfigs/" + "PT_" + modToLoad.id + ".asset";
            if (System.IO.File.Exists(path))
            {
                ...
                path = "Assets/BDT/Resources/Data/" + modToLoad.id + "/PartyTemplates";
                if (AssetDatabase.IsValidFolder(path))
                {
            ...
            path = "Assets/BDT/Resources/SubModulesData/" + modToLoad.id + "/ModDataConfigs/" + "hero_" + modToLoad.id + ".asset";
            if (System.IO.File.Exists(path))
            {
                ...
                path = "Assets/BDT/Resources/Data/" + modToLoad.id + "/Heroes";
                if (AssetDatabase.IsValidFolder(path))
                {
            ...
            path = "Assets/BDT/Resources/SubModulesData/" + modToLoad.id + "/ModDataConfigs/" + "language_" + modToLoad.id + ".asset";
            if (System.IO.File.Exists(path))
            {
                ...
                path = "Assets/BDT/Resources/Data/" + modToLoad.id + "/TranslationData/_Languages";
                if (AssetDatabase.IsValidFolder(path))
                {
            ...
            // Load Items
            path = "Assets/BDT/Resources/SubModulesData/" + modToLoad.id + "/ModDataConfigs/" + "item_" + modToLoad.id + ".asset";
            if (System.IO.File.Exists(path))
            {
                ...
                path = "Assets/BDT/Resources/Data/" + modToLoad.id + "/Items";
                if (AssetDatabase.IsValidFolder(path))
                {
            ...
            // Load Equipment Sets
            path = "Assets/BDT/Resources/SubModulesData/" + modToLoad.id + "/ModDataConfigs/" + "equipment_set_" + modToLoad.id + ".asset";
            if (System.IO.File.Exists(path))
            {
                ...
                // rosters
                path = "Assets/BDT/Resources/Data/" + modToLoad.id + "/NPC/Equipment/EquipmentRosters";
                if (AssetDatabase.IsValidFolder(path))
                {
                ...
                // main
                path = "Assets/BDT/Resources/Data/" + modToLoad.id + "/NPC/Equipment/EquipmentMain";
                if (AssetDatabase.IsValidFolder(path))
                {
                    string[] eqp_roster_AssetFiles = Directory.GetFiles(path, "*.asset");
                    foreach (string file in eqp_roster_AssetFiles)
                ...
                // Equip Sets
                path = "Assets/BDT/Resources/Data/" + modToLoad.id + "/Sets/Equipments/EqpSets";
                if (AssetDatabase.IsValidFolder(path))
                {
                    string[] eqp_roster_AssetFiles = Directory.GetFiles(path, "*.asset");
                    foreach (string file in eqp_roster_AssetFiles)
            ...
            // Load Equipments
            path = "Assets/BDT/Resources/SubModulesData/" + modToLoad.id + "/ModDataConfigs/" + "equipments_" + modToLoad.id + ".asset";
            if (System.IO.File.Exists(path))
            {
                ...
                // rosters
                path = "Assets/BDT/Resources/Data/" + modToLoad.id + "/Sets/Equipments";
                if (AssetDatabase.IsValidFolder(path))
                {
                    string[] eqp_roster_AssetFiles = Directory.GetFiles(path, "*.asset");
                    foreach (string file in eqp_roster_AssetFiles)
            ...
            // Lenguages
            path = "Assets/BDT/Resources/SubModulesData/" + modToLoad.id + "/ModDataConfigs/" + "translation_" + modToLoad.id + ".asset";
            if (System.IO.File.Exists(path))
            {
                ...
                path = "Assets/BDT/Resources/Data/" + modToLoad.id + "/TranslationData";

                string[] directories = Directory.GetDirectories("Assets/BDT/Resources/Data/" + modToLoad.id + "/TranslationData");
            ...
            // Export Settings
            path = "Assets/BDT/Resources/SubModulesData/" + modToLoad.id + "/ModDataConfigs/" + "export_" + modToLoad.id + ".asset";
            if (System.IO.File.Exists(path))
            {
    ...
    private void DeleteCurrentMod()
    {
        ...
        string dataPath = $"Assets/BDT/Resources/Data/{currentMod.id}";
        string sub_dataPath = $"Assets/BDT/Resources/SubModulesData/{currentMod.id}";
        string sub_dataPathConfigMeta = $"Assets/BDT/Resources/SubModulesData/{currentMod.id}.asset.meta";
        string mod_asset = $"Assets/BDT/Resources/SubModulesData/{currentMod.id}.asset";
    ...
    {
        var path = "Assets/BDT/Resources/SubModulesData";
        if (AssetDatabase.IsValidFolder(path))
        {
            //modToLoad.modFilesData.npcChrData.NPCCharacters = new List<NPCCharacter>();
    ...
    private void DrawDebugOptions()
    {
        ...
        if (DebugOptions)
        {
            ...
            if (GUILayout.Button("Load Item Definitions Assets"))
            {
                ...
                // string path = "Assets/BDT/Settings/Definitions/ItemTypes" + def + ".asset";
                string[] itemTypesAssets = Directory.GetFiles("Assets/BDT/Settings/Definitions/ItemTypes", "*.asset");
            ...
            if (GUILayout.Button("Import Item Modifiers"))
            {
                ...
                {
                    path = "Assets/BDT/Settings/Definitions/ItemModifierGroups/" + modifierData.itemModifierGroup_id + ".asset";
            ...
            if (GUILayout.Button("Import Pieces From Native"))
            {
                ...
                {
                    path = "Assets/BDT/Settings/Definitions/CraftingPieces/" + pieceData.ID + ".asset";
            ...
            {
                string[] pieceAssets = Directory.GetFiles("Assets/BDT/Settings/Definitions/CraftingPieces", "*.asset");
            ...
            {
                var path = "Assets/BDT/Settings/BannersEditor/BannerEditor_settings.asset";
                ...
                string[] groupDirs = Directory.GetDirectories("Assets/BDT/Settings/BannersEditor/Resources/sprites");
            ...
            if (GUILayout.Button("Read Banner editor Colors Pattern"))
            {
                ...
                var patternPath = "Assets/BDT/Settings/BannersEditor/Resources/colorsPattern.png";
